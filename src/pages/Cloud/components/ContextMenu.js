 ...
 * 
 * @param {Object} props
 * @param {Number} props.clientX
 * @param {Number} props.clientY
 * @param {?Array} props.items  {items_a: true, items_b: false}
 * 
 */
...
class ContextMenu extends React.Component {
    ...
    render() {
        ...
        return(visible || null) && 
            <div ref={ref => {this.root = ref}} className={styles.wrap} style={style.wrap}>
